...
"use strict";var P=Object.defineProperty;var ie=Object.getOwnPropertyDescriptor;var ae=Object.getOwnPropertyNames;var de=Object.prototype.hasOwnProperty;var _e=(a,e)=>{for(var s in e)P(a,s,{get:e[s],enumerable:!0})},pe=(a,e,s,t)=>{if(e&&typeof e=="object"||typeof e=="function")for(let r of ae(e))!de.call(a,r)&&r!==s&&P(a,r,{get:()=>e[r],enumerable:!(t=ie(e,r))||t.enumerable});return a};var ue=a=>pe(P({},"__esModule",{value:!0}),a);var ve={};_e(ve,{SessionStore:()=>j});module.exports=ue(ve);var W=require("bun:sqlite"),x=require("fs");var l=require("path"),k=require("os"),D=require("fs"),q=require("url");var Ee=null;function me(a){return(Ee??process.stderr.write.bind(process.stderr))(a)}function M(a){me(a)}var Ue=process.platform==="win32";function ce(a){return a.replace(/^\uFEFF/,"")}function F(a){return JSON.parse(ce(a))}function le(){return typeof __dirname<"u"?__dirname:(0,l.dirname)((0,q.fileURLToPath)(__IMPORT_META_URL__))}var xe=le();function Te(){if(process.env.CLAUDE_MEM_DATA_DIR)return process.env.CLAUDE_MEM_DATA_DIR;let a=(0,l.join)((0,k.homedir)(),".claude-mem"),e=(0,l.join)(a,"settings.json");try{if((0,D.existsSync)(e)){let s=F((0,D.readFileSync)(e,"utf-8")),t=s.env??s;if(t.CLAUDE_MEM_DATA_DIR)return t.CLAUDE_MEM_DATA_DIR}}catch{}return a}var I=Te(),be=process.env.CLAUDE_CONFIG_DIR||(0,l.join)((0,k.homedir)(),".claude"),Pe=(0,l.join)(be,"plugins","marketplaces","thedotmack"),Se=(0,l.join)(I,"logs"),ke=(0,l.join)(I,"settings.json"),V=(0,l.join)(I,"claude-mem.db"),Re=(0,l.join)(I,"observer-sessions"),X=(0,l.basename)(Re);function Y(a){(0,D.mkdirSync)(a,{recursive:!0})}var U={dataDir:()=>I,workerPid:()=>(0,l.join)(I,"worker.pid"),serverPid:()=>(0,l.join)(I,".server-beta.pid"),serverPort:()=>(0,l.join)(I,".server-beta.port"),serverRuntime:()=>(0,l.join)(I,".server-beta.runtime.json"),settings:()=>(0,l.join)(I,"settings.json"),database:()=>(0,l.join)(I,"claude-mem.db"),chroma:()=>(0,l.join)(I,"chroma"),combinedCerts:()=>(0,l.join)(I,"combined_certs.pem"),transcriptsConfig:()=>(0,l.join)(I,"transcript-watch.json"),transcriptsState:()=>(0,l.join)(I,"transcript-watch-state.json"),cloudSyncState:()=>(0,l.join)(I,"cloud-sync-state.json"),corpora:()=>(0,l.join)(I,"corpora"),supervisorRegistry:()=>(0,l.join)(I,"supervisor.json"),envFile:()=>(0,l.join)(I,".env"),logsDir:()=>Se};var v=require("fs"),K=require("path");var B=(n=>(n[n.DEBUG=0]="DEBUG",n[n.INFO=1]="INFO",n[n.WARN=2]="WARN",n[n.ERROR=3]="ERROR",n[n.SILENT=4]="SILENT",n))(B||{}),G=null,$=class{level=null;useColor;logFilePath=null;logFileInitialized=!1;constructor(){this.useColor=process.stdout.isTTY??!1}ensureLogFileInitialized(){if(!this.logFileInitialized){this.logFileInitialized=!0;try{let e=U.logsDir();(0,v.existsSync)(e)||(0,v.mkdirSync)(e,{recursive:!0});let s=new Date().toISOString().split("T")[0];this.logFilePath=(0,K.join)(e,`claude-mem-${s}.log`)}catch(e){console.error("[LOGGER] Failed to initialize log file:",e instanceof Error?e.message:String(e)),this.logFilePath=null}}}getLevel(){if(this.level===null)try{let e=U.settings();if((0,v.existsSync)(e)){let s=(0,v.readFileSync)(e,"utf-8"),r=(F(s).CLAUDE_MEM_LOG_LEVEL||"INFO").toUpperCase();this.level=B[r]??1}else this.level=1}catch(e){console.error("[LOGGER] Failed to load log level from settings:",e instanceof Error?e.message:String(e)),this.level=1}return this.level}formatData(e){if(e==null)return"";if(typeof e=="string")return e;if(typeof e=="number"||typeof e=="boolean")return e.toString();if(typeof e=="object"){if(e instanceof Error)return this.getLevel()===0?`${e.message}
...
`+JSON.stringify(n,null,2)}catch{E=" "+this.formatData(n)}else E=" "+this.formatData(n);let h="";if(r){let{sessionId:N,memorySessionId:f,correlationId:R,...m}=r;Object.keys(m).length>0&&(h=` {${Object.entries(m).map(([O,C])=>`${O}=${C}`).join(", ")}}`)}let T=`[${o}] [${i}] [${p}] ${_}${t}${h}${E}`;if(this.logFilePath)try{(0,v.appendFileSync)(this.logFilePath,T+`
`,"utf8")}catch(N){let f=N instanceof Error?N:new Error(String(N));M(`[LOGGER] Failed to write to log file: ${f.message}
${f.stack??""}
`)}else M(T+`
`)}debug(e,s,t,r){this.log(0,e,s,t,r)}info(e,s,t,r){this.log(1,e,s,t,r)}warn(e,s,t,r){this.log(2,e,s,t,r)}setErrorSink(e){G=e}error(e,s,t,r){this.log(3,e,s,t,r),this.routeErrorToSink(s,t,r)}routeErrorToSink(e,s,t){try{if(!G||!(t instanceof Error))return;G(t)}catch{}}dataIn(e,s,t,r){this.info(e,`\u2192 ${s}`,t,r)}dataOut(e,s,t,r){this.info(e,`\u2190 ${s}`,t,r)}success(e,s,t,r){this.info(e,`\u2713 ${s}`,t,r)}failure(e,s,t,r){this.error(e,`\u2717 ${s}`,t,r)}},d=new $;var Q=require("crypto");function J(a,e,s){return(0,Q.createHash)("sha256").update([a||"",e||"",s||""].join("\0")).digest("hex").slice(0,16)}var u="claude";function Ne(a){return a.trim().toLowerCase().replace(/\s+/g,"-")}function L(a){if(!a)return u;let e=Ne(a);return e?e==="transcript"||e.includes("codex")?"codex":e.includes("cursor")?"cursor":e.includes("claude")?"claude":e:u}function z(a){let e=["claude","codex","cursor"];return[...a].sort((s,t)=>{let r=e.indexOf(s),n=e.indexOf(t);return r!==-1||n!==-1?r===-1?1:n===-1?-1:r-n:s.localeCompare(t)})}function Z(a,e,s,t,r){let n=Date.now()-t,o=r!==void 0?"up.session_db_id = ?":"up.content_session_id = ?",i=r??e;return a.prepare(`
    SELECT
      up.*,
      s.memory_session_id,
      s.project,
    ...
    LIMIT 1
  `).get(i,s,n)??void 0}var te=["private","claude-mem-context","system_instruction","system-instruction","persisted-output","system-reminder"],ee=new RegExp(`<(${te.join("|")})\\b[^>]*>[\\s\\S]*?</\\1>`,"g");var se=100;function Ie(a){let e=Object.fromEntries(te.map(r=>[r,0]));ee.lastIndex=0;let s=0,t=a.replace(ee,(r,n)=>(e[n]=(e[n]??0)+1,s+=1,""));return s>se&&d.warn("SYSTEM","tag count exceeds limit",void 0,{tagCount:s,maxAllowed:se,contentLength:a.length}),{stripped:t.trim(),counts:e}}function re(a){return Ie(a).stripped}var he=["task-notification"],Ke=new RegExp(`^\\s*<(${he.join("|")})\\b[^>]*>(?:(?!<\\1\\b|</\\1\\b)[\\s\\S])*</\\1>\\s*$`),Qe=256*1024;var H=4e3;function w(a){let e=a.trim(),t=re(a).trim()||e;return t.length<=H?t:(d.debug("DB","Truncated stored prompt text to the configured cap",{originalLength:t.length,storedLength:H}),`${t.slice(0,H-1)}\u2026`)}var ge=require("bun:sqlite");var fe=5e3,Oe=4194304;function Ae(a){return a.prepare(`
    SELECT name
    FROM sqlite_master
    WHERE type = 'table'
      AND name NOT LIKE 'sqlite_%'
    LIMIT 1
  `).get()!=null}function y(a,e,s){try{a.run(e)}catch(t){let r=t instanceof Error?t:new Error(String(t));throw d.warn("DB",`Failed to apply SQLite pragma ${s}`,{sql:e},r),t}}function ne(a,e={}){let{enableWal:s=!0,enableIncrementalAutoVacuum:t=!0}=e;y(a,`PRAGMA busy_timeout = ${fe}`,"busy_timeout"),y(a,"PRAGMA foreign_keys = ON","foreign_keys"),y(a,"PRAGMA synchronous = NORMAL","synchronous"),y(a,`PRAGMA journal_size_limit = ${Oe}`,"journal_size_limit"),t&&!Ae(a)&&y(a,"PRAGMA auto_vacuum = INCREMENTAL","auto_vacuum"),s&&y(a,"PRAGMA journal_mode = WAL","journal_mode")}function oe(a){return a&&/^[A-Za-z0-9][A-Za-z0-9._-]{0,119}$/.test(a)?a:null}function Le(a){return a&&/^[A-Z][A-Z0-9_]{0,79}$/.test(a)?a:null}var j=class{db;constructor(e=V,s={}){e instanceof W.Database?this.db=e:(e!==":memory:"&&Y(I),this.db=new W.Database(e)),ne(this.db),this.initializeSchema(),this.ensureWorkerPortColumn(),this.ensurePromptTrackingColumns(),this.removeSessionSummariesUniqueConstraint(),this.addObservationHierarchicalFields(),this.makeObservationsTextNullable(),this.createUserPromptsTable(),this.ensureDiscoveryTokensColumn(),this.createPendingMessagesTable(),this.renameSessionIdColumns(),this.addFailedAtEpochColumn(),this.addOnUpdateCascadeToForeignKeys(),this.addObservationContentHashColumn(),this.addSessionCustomTitleColumn(),this.addSessionPlatformSourceColumn(),this.addObservationModelColumns(),this.ensureMergedIntoProjectColumns(),this.addObservationSubagentColumns(),this.addObservationsUniqueContentHashIndex(),this.addObservationsMetadataColumn(),this.dropDeadPendingMessagesColumns(),this.ensurePendingMessagesToolUseIdColumn(),this.dropWorkerPidColumn(),this.ensureSDKSessionsPlatformContentIdentity(),this.ensureUserPromptsSessionDbId(),this.ensurePendingMessagesSessionToolUniqueIndex(),this.ensureSyncedAtColumns(s.cloudSyncStatePath??U.cloudSyncState()),this.requeuePromptCloudSyncAfterMapperFix(),this.createProviderAuditTable()}recordProviderAudit(e){let s=new Date,t=this.db.prepare(`
    ...
    `).run(s.toISOString(),s.getTime(),e.action,oe(e.providerId),oe(e.profileId),e.mode??null,e.outcome,Le(e.errorCode),e.classification??null,Math.max(0,Math.min(1e6,Math.trunc(e.redactionCount??0))));return Number(t.lastInsertRowid)}getRecentProviderAudits(e=100){let s=Math.max(1,Math.min(500,Math.trunc(e)));return this.db.query(`
