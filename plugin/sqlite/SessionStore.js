...
"use strict";var P=Object.defineProperty;var ae=Object.getOwnPropertyDescriptor;var de=Object.getOwnPropertyNames;var _e=Object.prototype.hasOwnProperty;var ue=(i,e)=>{for(var s in e)P(i,s,{get:e[s],enumerable:!0})},pe=(i,e,s,t)=>{if(e&&typeof e=="object"||typeof e=="function")for(let r of de(e))!_e.call(i,r)&&r!==s&&P(i,r,{get:()=>e[r],enumerable:!(t=ae(e,r))||t.enumerable});return i};var Ee=i=>pe(P({},"__esModule",{value:!0}),i);var De={};ue(De,{SessionStore:()=>q});module.exports=Ee(De);var j=require("bun:sqlite"),k=require("fs");var l=require("path"),X=require("os"),D=require("fs"),V=require("url");var me=null;function ce(i){return(me??process.stderr.write.bind(process.stderr))(i)}function M(i){ce(i)}var Fe=process.platform==="win32";function le(i){return i.replace(/^\uFEFF/,"")}function F(i){return JSON.parse(le(i))}function Te(){return typeof __dirname<"u"?__dirname:(0,l.dirname)((0,V.fileURLToPath)(__IMPORT_META_URL__))}var Pe=Te();function be(){if(process.env.CLAUDE_MEM_DATA_DIR)return process.env.CLAUDE_MEM_DATA_DIR;let i=(0,l.join)((0,X.homedir)(),".claude-mem"),e=(0,l.join)(i,"settings.json");try{if((0,D.existsSync)(e)){let s=F((0,D.readFileSync)(e,"utf-8")),t=s.env??s;if(t.CLAUDE_MEM_DATA_DIR)return t.CLAUDE_MEM_DATA_DIR}}catch{}return i}var I=be(),Se=process.env.CLAUDE_CONFIG_DIR||(0,l.join)((0,X.homedir)(),".claude"),Xe=(0,l.join)(Se,"plugins","marketplaces","thedotmack"),Re=(0,l.join)(I,"logs"),Ge=(0,l.join)(I,"settings.json"),Y=(0,l.join)(I,"claude-mem.db"),Ne=(0,l.join)(I,"observer-sessions"),G=(0,l.basename)(Ne);function K(i){(0,D.mkdirSync)(i,{recursive:!0})}var U={dataDir:()=>I,workerPid:()=>(0,l.join)(I,"worker.pid"),serverPid:()=>(0,l.join)(I,".server-beta.pid"),serverPort:()=>(0,l.join)(I,".server-beta.port"),serverRuntime:()=>(0,l.join)(I,".server-beta.runtime.json"),settings:()=>(0,l.join)(I,"settings.json"),database:()=>(0,l.join)(I,"claude-mem.db"),chroma:()=>(0,l.join)(I,"chroma"),combinedCerts:()=>(0,l.join)(I,"combined_certs.pem"),transcriptsConfig:()=>(0,l.join)(I,"transcript-watch.json"),transcriptsState:()=>(0,l.join)(I,"transcript-watch-state.json"),cloudSyncState:()=>(0,l.join)(I,"cloud-sync-state.json"),corpora:()=>(0,l.join)(I,"corpora"),supervisorRegistry:()=>(0,l.join)(I,"supervisor.json"),envFile:()=>(0,l.join)(I,".env"),logsDir:()=>Re};var v=require("fs"),Q=require("path");var $=(n=>(n[n.DEBUG=0]="DEBUG",n[n.INFO=1]="INFO",n[n.WARN=2]="WARN",n[n.ERROR=3]="ERROR",n[n.SILENT=4]="SILENT",n))($||{}),B=null,H=class{level=null;useColor;logFilePath=null;logFileInitialized=!1;constructor(){this.useColor=process.stdout.isTTY??!1}ensureLogFileInitialized(){if(!this.logFileInitialized){this.logFileInitialized=!0;try{let e=U.logsDir();(0,v.existsSync)(e)||(0,v.mkdirSync)(e,{recursive:!0});let s=new Date().toISOString().split("T")[0];this.logFilePath=(0,Q.join)(e,`claude-mem-${s}.log`)}catch(e){console.error("[LOGGER] Failed to initialize log file:",e instanceof Error?e.message:String(e)),this.logFilePath=null}}}getLevel(){if(this.level===null)try{let e=U.settings();if((0,v.existsSync)(e)){let s=(0,v.readFileSync)(e,"utf-8"),r=(F(s).CLAUDE_MEM_LOG_LEVEL||"INFO").toUpperCase();this.level=$[r]??1}else this.level=1}catch(e){console.error("[LOGGER] Failed to load log level from settings:",e instanceof Error?e.message:String(e)),this.level=1}return this.level}formatData(e){if(e==null)return"";if(typeof e=="string")return e;if(typeof e=="number"||typeof e=="boolean")return e.toString();if(typeof e=="object"){if(e instanceof Error)return this.getLevel()===0?`${e.message}
${e.stack}`:e.message;if(Array.isArray(e))return`[${e.length} items]`;let s=Object.keys(e);return s.length===0?"{}":s.length<=3?JSON.stringify(e):`{${s.length} keys: ${s.slice(0,3).join(", ")}...}`}return String(e)}formatTool(e,s){if(!s)return e;let t=s;if(typeof s=="string")try{t=JSON.parse(s)}catch{t=s}if(e==="Bash"&&t.command)return`${e}(${t.command})`;if(t.file_path)return`${e}(${t.file_path})`;if(t.notebook_path)return`${e}(${t.notebook_path})`;if(e==="Glob"&&t.pattern)return`${e}(${t.pattern})`;if(e==="Grep"&&t.pattern)return`${e}(${t.pattern})`;if(t.url)return`${e}(${t.url})`;if(t.query)return`${e}(${t.query})`;if(e==="Task"){if(t.subagent_type)return`${e}(${t.subagent_type})`;if(t.description)return`${e}(${t.description})`}return e==="Skill"&&t.skill?`${e}(${t.skill})`:e==="LSP"&&t.operation?`${e}(${t.operation})`:e}formatTimestamp(e){let s=e.getFullYear(),t=String(e.getMonth()+1).padStart(2,"0"),r=String(e.getDate()).padStart(2,"0"),n=String(e.getHours()).padStart(2,"0"),o=String(e.getMinutes()).padStart(2,"0"),a=String(e.getSeconds()).padStart(2,"0"),u=String(e.getMilliseconds()).padStart(3,"0");return`${s}-${t}-${r} ${n}:${o}:${a}.${u}`}log(e,s,t,r,n){if(e<this.getLevel())return;this.ensureLogFileInitialized();let o=this.formatTimestamp(new Date),a=$[e].padEnd(5),u=s.padEnd(6),_="";r?.correlationId?_=`[${r.correlationId}] `:r?.sessionId&&(_=`[session-${r.sessionId}] `);let E="";if(n!=null)if(n instanceof Error)E=this.getLevel()===0?`
${n.message}
${n.stack}`:` ${n.message}`;else if(this.getLevel()===0&&typeof n=="object")try{E=`
`+JSON.stringify(n,null,2)}catch{E=" "+this.formatData(n)}else E=" "+this.formatData(n);let h="";if(r){let{sessionId:N,memorySessionId:f,correlationId:R,...m}=r;Object.keys(m).length>0&&(h=` {${Object.entries(m).map(([O,C])=>`${O}=${C}`).join(", ")}}`)}let T=`[${o}] [${a}] [${u}] ${_}${t}${h}${E}`;if(this.logFilePath)try{(0,v.appendFileSync)(this.logFilePath,T+`
`,"utf8")}catch(N){let f=N instanceof Error?N:new Error(String(N));M(`[LOGGER] Failed to write to log file: ${f.message}
${f.stack??""}
`)}else M(T+`
`)}debug(e,s,t,r){this.log(0,e,s,t,r)}info(e,s,t,r){this.log(1,e,s,t,r)}warn(e,s,t,r){this.log(2,e,s,t,r)}setErrorSink(e){B=e}error(e,s,t,r){this.log(3,e,s,t,r),this.routeErrorToSink(s,t,r)}routeErrorToSink(e,s,t){try{if(!B||!(t instanceof Error))return;B(t)}catch{}}dataIn(e,s,t,r){this.info(e,`\u2192 ${s}`,t,r)}dataOut(e,s,t,r){this.info(e,`\u2190 ${s}`,t,r)}success(e,s,t,r){this.info(e,`\u2713 ${s}`,t,r)}failure(e,s,t,r){this.error(e,`\u2717 ${s}`,t,r)}},d=new H;var J=require("crypto");function z(i,e,s){return(0,J.createHash)("sha256").update([i||"",e||"",s||""].join("\0")).digest("hex").slice(0,16)}var p="claude";function Ie(i){return i.trim().toLowerCase().replace(/\s+/g,"-")}function L(i){if(!i)return p;let e=Ie(i);return e?e==="transcript"||e.includes("codex")?"codex":e.includes("cursor")?"cursor":e.includes("claude")?"claude":e:p}function Z(i){let e=["claude","codex","cursor"];return[...i].sort((s,t)=>{let r=e.indexOf(s),n=e.indexOf(t);return r!==-1||n!==-1?r===-1?1:n===-1?-1:r-n:s.localeCompare(t)})}function ee(i,e,s,t,r){let n=Date.now()-t,o=r!==void 0?"up.session_db_id = ?":"up.content_session_id = ?",a=r??e;return i.prepare(`
    SELECT
      up.*,
      s.memory_session_id,
      s.project,
    ...
    LIMIT 1
  `).get(a,s,n)??void 0}var re=["private","claude-mem-context","system_instruction","system-instruction","persisted-output","system-reminder"],se=new RegExp(`<(${re.join("|")})\\b[^>]*>[\\s\\S]*?</\\1>`,"g");var te=100;function he(i){let e=Object.fromEntries(re.map(r=>[r,0]));se.lastIndex=0;let s=0,t=i.replace(se,(r,n)=>(e[n]=(e[n]??0)+1,s+=1,""));return s>te&&d.warn("SYSTEM","tag count exceeds limit",void 0,{tagCount:s,maxAllowed:te,contentLength:i.length}),{stripped:t.trim(),counts:e}}function ne(i){return he(i).stripped}var ge=["task-notification"],Je=new RegExp(`^\\s*<(${ge.join("|")})\\b[^>]*>(?:(?!<\\1\\b|</\\1\\b)[\\s\\S])*</\\1>\\s*$`),ze=256*1024;var W=4e3;function w(i){let e=i.trim(),t=ne(i).trim()||e;return t.length<=W?t:(d.debug("DB","Truncated stored prompt text to the configured cap",{originalLength:t.length,storedLength:W}),`${t.slice(0,W-1)}\u2026`)}var fe=require("bun:sqlite");var Oe=5e3,Ae=4194304;function Le(i){return i.prepare(`
    SELECT name
    FROM sqlite_master
    WHERE type = 'table'
      AND name NOT LIKE 'sqlite_%'
    LIMIT 1
  `).get()!=null}function y(i,e,s){try{i.run(e)}catch(t){let r=t instanceof Error?t:new Error(String(t));throw d.warn("DB",`Failed to apply SQLite pragma ${s}`,{sql:e},r),t}}function oe(i,e={}){let{enableWal:s=!0,enableIncrementalAutoVacuum:t=!0}=e;y(i,`PRAGMA busy_timeout = ${Oe}`,"busy_timeout"),y(i,"PRAGMA foreign_keys = ON","foreign_keys"),y(i,"PRAGMA synchronous = NORMAL","synchronous"),y(i,`PRAGMA journal_size_limit = ${Ae}`,"journal_size_limit"),t&&!Le(i)&&y(i,"PRAGMA auto_vacuum = INCREMENTAL","auto_vacuum"),s&&y(i,"PRAGMA journal_mode = WAL","journal_mode")}function ie(i){return i&&/^[A-Za-z0-9][A-Za-z0-9._-]{0,119}$/.test(i)?i:null}function ve(i){return i&&/^[A-Z][A-Z0-9_]{0,79}$/.test(i)?i:null}function Ce(i){return i&&/^[A-Za-z0-9][A-Za-z0-9._:/-]{0,199}$/.test(i)?i:null}function x(i){return Number.isFinite(i)?Math.max(0,Math.min(1e9,Math.trunc(i))):null}var q=class{db;constructor(e=Y,s={}){e instanceof j.Database?this.db=e:(e!==":memory:"&&K(I),this.db=new j.Database(e)),oe(this.db),this.initializeSchema(),this.ensureWorkerPortColumn(),this.ensurePromptTrackingColumns(),this.removeSessionSummariesUniqueConstraint(),this.addObservationHierarchicalFields(),this.makeObservationsTextNullable(),this.createUserPromptsTable(),this.ensureDiscoveryTokensColumn(),this.createPendingMessagesTable(),this.renameSessionIdColumns(),this.addFailedAtEpochColumn(),this.addOnUpdateCascadeToForeignKeys(),this.addObservationContentHashColumn(),this.addSessionCustomTitleColumn(),this.addSessionPlatformSourceColumn(),this.addObservationModelColumns(),this.ensureMergedIntoProjectColumns(),this.addObservationSubagentColumns(),this.addObservationsUniqueContentHashIndex(),this.addObservationsMetadataColumn(),this.dropDeadPendingMessagesColumns(),this.ensurePendingMessagesToolUseIdColumn(),this.dropWorkerPidColumn(),this.ensureSDKSessionsPlatformContentIdentity(),this.ensureUserPromptsSessionDbId(),this.ensurePendingMessagesSessionToolUniqueIndex(),this.ensureSyncedAtColumns(s.cloudSyncStatePath??U.cloudSyncState()),this.requeuePromptCloudSyncAfterMapperFix(),this.createProviderAuditTable()}recordProviderAudit(e){let s=new Date,t=this.db.prepare(`
    ...
    `).run(s.toISOString(),s.getTime(),e.action,ie(e.providerId),ie(e.profileId),e.mode??null,e.outcome,ve(e.errorCode),e.classification??null,Math.max(0,Math.min(1e6,Math.trunc(e.redactionCount??0))),Ce(e.model),e.protocol==="anthropic"||e.protocol==="openai-compatible"?e.protocol:null,x(e.requestChars),x(e.latencyMs),x(e.inputTokens),x(e.outputTokens));return Number(t.lastInsertRowid)}getRecentProviderAudits(e=100){let s=Math.max(1,Math.min(500,Math.trunc(e)));return this.db.query(`
    ...
    `),this.db.run(`
      ...
      SELECT
        ...
        status, worker_port, prompt_counter, custom_title
      FROM sdk_sessions
    `),this.db.run("DROP TABLE sdk_sessions"),this.db.run("ALTER TABLE sdk_sessions_new RENAME TO sdk_sessions"),this.db.run("CREATE INDEX IF NOT EXISTS idx_sdk_sessions_claude_id ON sdk_sessions(content_session_id)"),this.db.run("CREATE INDEX IF NOT EXISTS idx_sdk_sessions_sdk_id ON sdk_sessions(memory_session_id)"),this.db.run("CREATE INDEX IF NOT EXISTS idx_sdk_sessions_project ON sdk_sessions(project)"),this.db.run("CREATE INDEX IF NOT EXISTS idx_sdk_sessions_status ON sdk_sessions(status)"),this.db.run("CREATE INDEX IF NOT EXISTS idx_sdk_sessions_started ON sdk_sessions(started_at_epoch DESC)"),this.db.run("CREATE INDEX IF NOT EXISTS idx_sdk_sessions_platform_source ON sdk_sessions(platform_source)"),this.db.run("CREATE UNIQUE INDEX IF NOT EXISTS ux_sdk_sessions_platform_content ON sdk_sessions(platform_source, content_session_id)"),e||this.db.prepare("INSERT OR IGNORE INTO schema_versions (version, applied_at) VALUES (?, ?)").run(33,new Date().toISOString())}ensureUserPromptsSessionDbId(){let e=this.db.prepare("SELECT version FROM schema_versions WHERE version = ?").get(34);if(this.db.query("SELECT name FROM sqlite_master WHERE type='table' AND name='user_prompts'").all().length===0){this.db.prepare("INSERT OR IGNORE INTO schema_versions (version, applied_at) VALUES (?, ?)").run(34,new Date().toISOString());return}let r=this.db.query("PRAGMA table_info(user_prompts)").all().some(_=>_.name==="session_db_id"),o=this.db.query("PRAGMA foreign_key_list(user_prompts)").all().some(_=>_.table==="sdk_sessions"&&_.from==="content_session_id");if(e&&r&&!o)return;let a=this.db.prepare("SELECT name FROM sqlite_master WHERE type='table' AND name='user_prompts_fts'").all().length>0,u=r?`COALESCE(up.session_db_id, (
    ...
    `).run();d.info("DB","Requeued prompt cloud sync after mapper fix (v40)",{requeued:s.changes}),this.db.prepare("INSERT OR IGNORE INTO schema_versions (version, applied_at) VALUES (?, ?)").run(40,new Date().toISOString())}createProviderAuditTable(){this.db.run(`
    ...
    `).get(e);if(!r)throw new Error(`Session ${e} not found in sdk_sessions`);r.memory_session_id!==s&&(this.db.prepare(`
      ...
      WHERE project IS NOT NULL AND project != ''
        AND project != ?
    `,r=[G];return s&&(t+=" AND COALESCE(platform_source, ?) = ?",r.push(p,s)),t+=" ORDER BY project ASC",this.db.prepare(t).all(...r).map(o=>o.project)}getProjectCatalog(){let e=this.db.prepare(`
      SELECT
    ...
    `).all(G),s=[],t=new Set,r={};for(let o of e){let a=L(o.platform_source);r[a]||(r[a]=[]),r[a].includes(o.project)||r[a].push(o.project),t.has(o.project)||(t.add(o.project),s.push(o.project))}let n=Z(Object.keys(r));return{projects:s,sources:n,projectsBySource:Object.fromEntries(n.map(o=>[o,r[o]||[]]))}}getLatestUserPrompt(e,s){let t=this.resolvePromptSessionDbId(e,s),r=t!==null?"up.session_db_id = ?":"up.content_session_id = ?",n=t!==null?t:e;return this.db.prepare(`
      ...
      ORDER BY up.created_at_epoch DESC
      LIMIT 1
    `).get(n)}findRecentDuplicateUserPrompt(e,s,t,r){return ee(this.db,e,w(s),t,this.resolvePromptSessionDbId(e,r)??void 0)}getRecentSessionsWithStatus(e,s=3,t){let r=[e],n="";return t&&(n=`AND COALESCE(NULLIF(s.platform_source, ''), '${p}') = ?`,r.push(L(t))),r.push(s),this.db.prepare(`
      SELECT * FROM (
        SELECT
          s.memory_session_id,
          s.status,
    ...
    `).get(e,L(s))||null:this.db.prepare(`
      ...
      ${h}
      ${T}
    `).all(...f);if(!E)return O;let C=new Map(O.map(g=>[g.id,g])),b=e.map(g=>C.get(g)).filter(g=>!!g);return r?b.slice(0,r):b}getSummaryForSession(e,s){let t=[e],r="";return s&&(r=`
        AND EXISTS (
          SELECT 1
    ...
    `).get(e).count}createSDKSession(e,s,t,r,n){let o=new Date,a=o.getTime(),u=n?L(n):p,_=w(t),E=this.db.prepare(`
    ...
    `).get(p,u,e);if(E)return s&&this.db.prepare(`
      ...
      VALUES (?, NULL, ?, ?, ?, ?, ?, ?, 'active')
    `).run(e,s,u,_,r||null,o.toISOString(),a);return Number(h.lastInsertRowid)}saveUserPrompt(e,s,t,r){let n=new Date,o=n.getTime(),a=w(t),u=this.resolvePromptSessionDbId(e,r);return this.db.prepare(`
      INSERT INTO user_prompts
      (session_db_id, content_session_id, prompt_number, prompt_text, created_at, created_at_epoch)
      VALUES (?, ?, ?, ?, ?, ?)
    `).run(u,e,s,a,n.toISOString(),o).lastInsertRowid}getUserPrompt(e,s,t){let r=this.resolvePromptSessionDbId(e,t);return r!==null?this.db.prepare(`
        SELECT prompt_text
        FROM user_prompts
      ...
      LIMIT 1
    `).get(e,s)?.prompt_text??null}storeObservation(e,s,t,r,n=0,o,a){let u=this.storeObservations(e,s,[t],null,r,n,o,a);return{id:u.observationIds[0],createdAtEpoch:u.createdAtEpoch}}storeSummary(e,s,t,r,n=0,o){let a=o??Date.now(),u=new Date(a).toISOString(),E=this.db.prepare(`
      INSERT INTO session_summaries
      (memory_session_id, project, request, investigated, learned, completed,
       next_steps, notes, prompt_number, discovery_tokens, created_at, created_at_epoch)
      VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)
    `).run(e,s,t.request,t.investigated,t.learned,t.completed,t.next_steps,t.notes,r||null,n,u,a);return{id:Number(E.lastInsertRowid),createdAtEpoch:a}}storeObservations(e,s,t,r,n,o=0,a,u){let _=a??Date.now(),E=new Date(_).toISOString();return this.db.transaction(()=>{let T=[],N=this.db.prepare(`
      ...
      ${u}
      ${_}
    `).all(...h);if(!a)return R;let m=new Map(R.map(O=>[O.id,O])),c=e.map(O=>m.get(O)).filter(O=>!!O);return r?c.slice(0,r):c}getUserPromptsByIds(e,s={}){if(e.length===0)return[];let{orderBy:t="date_desc",limit:r,project:n,platformSource:o}=s,a=t==="relevance",u=a?"":`ORDER BY up.created_at_epoch ${t==="date_asc"?"ASC":"DESC"}`,_=r?`LIMIT ${r}`:"",E=e.map(()=>"?").join(","),h=[...e],T=[];n&&(T.push("s.project = ?"),h.push(n)),o&&(T.push(`COALESCE(NULLIF(s.platform_source, ''), '${p}') = ?`),h.push(L(o)));let N=T.length>0?`AND ${T.join(" AND ")}`:"",R=this.db.prepare(`
      SELECT
        up.*,
        s.project,
        s.memory_session_id,
      ...
      ${u}
      ${_}
    `).all(...h);if(!a)return R;let m=new Map(R.map(c=>[c.id,c]));return e.map(c=>m.get(c)).filter(c=>!!c)}getTimelineAroundTimestamp(e,s=10,t=10,r,n){return this.getTimelineAroundObservation(null,e,s,t,r,n)}getTimelineAroundObservation(e,s,t=10,r=10,n,o){let a=o?L(o):void 0,u=(b,g)=>{let S=[],A=[];return n&&(S.push(`${b}.project = ?`),A.push(n)),a&&(S.push(`COALESCE(NULLIF(${g}.platform_source, ''), '${p}') = ?`),A.push(a)),{clause:S.length>0?`AND ${S.join(" AND ")}`:"",params:A}},_=u("o","src"),E=u("ss","src"),h=u("s","s"),T,N;if(e!==null){let b=`
