"use strict";var Wt=Object.create;var V=Object.defineProperty;var jt=Object.getOwnPropertyDescriptor;var Vt=Object.getOwnPropertyNames;var qt=Object.getPrototypeOf,Yt=Object.prototype.hasOwnProperty;var Kt=(r,e)=>{for(var t in e)V(r,t,{get:e[t],enumerable:!0})},Oe=(r,e,t,s)=>{if(e&&typeof e=="object"||typeof e=="function")for(let n of Vt(e))!Yt.call(r,n)&&n!==t&&V(r,n,{get:()=>e[n],enumerable:!(s=jt(e,n))||s.enumerable});return r};var X=(r,e,t)=>(t=r!=null?Wt(qt(r)):{},Oe(e||!r||!r.__esModule?V(t,"default",{value:r,enumerable:!0}):t,r)),Jt=r=>Oe(V({},"__esModule",{value:!0}),r);var Us={};Kt(Us,{generateContext:()=>Bt,generateContextWithStats:()=>be});module.exports=Jt(Us);var Xt=X(require("path"),1),Gt=require("os"),Ht=require("fs");var me=require("bun:sqlite"),K=require("fs");var S=require("path"),ie=require("os"),P=require("fs"),Ie=require("url");var T=require("fs"),he=require("crypto"),v=require("path");var Qt=null;function zt(r){return(Qt??process.stderr.write.bind(process.stderr))(r)}function w(r){zt(r)}var Zt=process.platform==="win32";function es(r){return r.replace(/^\uFEFF/,"")}function k(r){return JSON.parse(es(r))}function ts(r){(0,T.existsSync)(r)||(0,T.mkdirSync)(r,{recursive:!0})}function oe(r,e){let t=r;try{if((0,T.lstatSync)(r).isSymbolicLink())try{t=(0,T.realpathSync)(r)}catch(_){let u=_ instanceof Error?_:new Error(String(_));w(`claude-mem: realpathSync failed for ${r}, resolving symlink manually: ${u.message}
`);let m=(0,T.readlinkSync)(r);t=(0,v.resolve)((0,v.dirname)(r),m)}}catch(_){let u=_.code;if(u!=="ENOENT"&&u!=="ENOTDIR")throw _}ts((0,v.dirname)(t));let s=(0,v.dirname)(t),n=(0,v.basename)(t),o=(0,v.join)(s,`.${n}.${process.pid}.${(0,he.randomBytes)(6).toString("hex")}.tmp`),i=Buffer.from(JSON.stringify(e,null,2)+`
...
`)}finally{if(u!==void 0)try{(0,T.closeSync)(u)}catch{}}}}catch(_){if(d!==void 0)try{(0,T.closeSync)(d)}catch{}try{(0,T.unlinkSync)(o)}catch{}throw _}}var as={};function ss(){return typeof __dirname<"u"?__dirname:(0,S.dirname)((0,Ie.fileURLToPath)(as.url))}var rs=ss();function ns(){if(process.env.CLAUDE_MEM_DATA_DIR)return process.env.CLAUDE_MEM_DATA_DIR;let r=(0,S.join)((0,ie.homedir)(),".claude-mem"),e=(0,S.join)(r,"settings.json");try{if((0,P.existsSync)(e)){let t=k((0,P.readFileSync)(e,"utf-8")),s=t.env??t;if(s.CLAUDE_MEM_DATA_DIR)return s.CLAUDE_MEM_DATA_DIR}}catch{}return r}var N=ns(),ae=process.env.CLAUDE_CONFIG_DIR||(0,S.join)((0,ie.homedir)(),".claude"),Xs=(0,S.join)(ae,"plugins","marketplaces","thedotmack"),os=(0,S.join)(N,"logs"),Gs=(0,S.join)(N,"settings.json"),Ne=(0,S.join)(N,"claude-mem.db"),is=(0,S.join)(N,"observer-sessions"),de=(0,S.basename)(is);function Ae(r){(0,P.mkdirSync)(r,{recursive:!0})}function Le(){return(0,S.join)(rs,"..")}var x={dataDir:()=>N,workerPid:()=>(0,S.join)(N,"worker.pid"),serverPid:()=>(0,S.join)(N,".server-beta.pid"),serverPort:()=>(0,S.join)(N,".server-beta.port"),serverRuntime:()=>(0,S.join)(N,".server-beta.runtime.json"),settings:()=>(0,S.join)(N,"settings.json"),database:()=>(0,S.join)(N,"claude-mem.db"),chroma:()=>(0,S.join)(N,"chroma"),combinedCerts:()=>(0,S.join)(N,"combined_certs.pem"),transcriptsConfig:()=>(0,S.join)(N,"transcript-watch.json"),transcriptsState:()=>(0,S.join)(N,"transcript-watch-state.json"),cloudSyncState:()=>(0,S.join)(N,"cloud-sync-state.json"),corpora:()=>(0,S.join)(N,"corpora"),supervisorRegistry:()=>(0,S.join)(N,"supervisor.json"),envFile:()=>(0,S.join)(N,".env"),logsDir:()=>os};var y=require("fs"),Ce=require("path");var Ee=(o=>(o[o.DEBUG=0]="DEBUG",o[o.INFO=1]="INFO",o[o.WARN=2]="WARN",o[o.ERROR=3]="ERROR",o[o.SILENT=4]="SILENT",o))(Ee||{}),_e=null,ue=class{level=null;useColor;logFilePath=null;logFileInitialized=!1;constructor(){this.useColor=process.stdout.isTTY??!1}ensureLogFileInitialized(){if(!this.logFileInitialized){this.logFileInitialized=!0;try{let e=x.logsDir();(0,y.existsSync)(e)||(0,y.mkdirSync)(e,{recursive:!0});let t=new Date().toISOString().split("T")[0];this.logFilePath=(0,Ce.join)(e,`claude-mem-${t}.log`)}catch(e){console.error("[LOGGER] Failed to initialize log file:",e instanceof Error?e.message:String(e)),this.logFilePath=null}}}getLevel(){if(this.level===null)try{let e=x.settings();if((0,y.existsSync)(e)){let t=(0,y.readFileSync)(e,"utf-8"),n=(k(t).CLAUDE_MEM_LOG_LEVEL||"INFO").toUpperCase();this.level=Ee[n]??1}else this.level=1}catch(e){console.error("[LOGGER] Failed to load log level from settings:",e instanceof Error?e.message:String(e)),this.level=1}return this.level}formatData(e){if(e==null)return"";if(typeof e=="string")return e;if(typeof e=="number"||typeof e=="boolean")return e.toString();if(typeof e=="object"){if(e instanceof Error)return this.getLevel()===0?`${e.message}
${e.stack}`:e.message;if(Array.isArray(e))return`[${e.length} items]`;let t=Object.keys(e);return t.length===0?"{}":t.length<=3?JSON.stringify(e):`{${t.length} keys: ${t.slice(0,3).join(", ")}...}`}return String(e)}formatTool(e,t){if(!t)return e;let s=t;if(typeof t=="string")try{s=JSON.parse(t)}catch{s=t}if(e==="Bash"&&s.command)return`${e}(${s.command})`;if(s.file_path)return`${e}(${s.file_path})`;if(s.notebook_path)return`${e}(${s.notebook_path})`;if(e==="Glob"&&s.pattern)return`${e}(${s.pattern})`;if(e==="Grep"&&s.pattern)return`${e}(${s.pattern})`;if(s.url)return`${e}(${s.url})`;if(s.query)return`${e}(${s.query})`;if(e==="Task"){if(s.subagent_type)return`${e}(${s.subagent_type})`;if(s.description)return`${e}(${s.description})`}return e==="Skill"&&s.skill?`${e}(${s.skill})`:e==="LSP"&&s.operation?`${e}(${s.operation})`:e}formatTimestamp(e){let t=e.getFullYear(),s=String(e.getMonth()+1).padStart(2,"0"),n=String(e.getDate()).padStart(2,"0"),o=String(e.getHours()).padStart(2,"0"),i=String(e.getMinutes()).padStart(2,"0"),a=String(e.getSeconds()).padStart(2,"0"),d=String(e.getMilliseconds()).padStart(3,"0");return`${t}-${s}-${n} ${o}:${i}:${a}.${d}`}log(e,t,s,n,o){if(e<this.getLevel())return;this.ensureLogFileInitialized();let i=this.formatTimestamp(new Date),a=Ee[e].padEnd(5),d=t.padEnd(6),_="";n?.correlationId?_=`[${n.correlationId}] `:n?.sessionId&&(_=`[session-${n.sessionId}] `);let u="";if(o!=null)if(o instanceof Error)u=this.getLevel()===0?`
${o.message}
${o.stack}`:` ${o.message}`;else if(this.getLevel()===0&&typeof o=="object")try{u=`
`+JSON.stringify(o,null,2)}catch{u=" "+this.formatData(o)}else u=" "+this.formatData(o);let m="";if(n){let{sessionId:g,memorySessionId:I,correlationId:h,...f}=n;Object.keys(f).length>0&&(m=` {${Object.entries(f).map(([C,U])=>`${C}=${U}`).join(", ")}}`)}let p=`[${i}] [${a}] [${d}] ${_}${s}${m}${u}`;if(this.logFilePath)try{(0,y.appendFileSync)(this.logFilePath,p+`
`,"utf8")}catch(g){let I=g instanceof Error?g:new Error(String(g));w(`[LOGGER] Failed to write to log file: ${I.message}
${I.stack??""}
`)}else w(p+`
`)}debug(e,t,s,n){this.log(0,e,t,s,n)}info(e,t,s,n){this.log(1,e,t,s,n)}warn(e,t,s,n){this.log(2,e,t,s,n)}setErrorSink(e){_e=e}error(e,t,s,n){this.log(3,e,t,s,n),this.routeErrorToSink(t,s,n)}routeErrorToSink(e,t,s){try{if(!_e||!(s instanceof Error))return;_e(s)}catch{}}dataIn(e,t,s,n){this.info(e,`\u2192 ${t}`,s,n)}dataOut(e,t,s,n){this.info(e,`\u2190 ${t}`,s,n)}success(e,t,s,n){this.info(e,`\u2713 ${t}`,s,n)}failure(e,t,s,n){this.error(e,`\u2717 ${t}`,s,n)}},E=new ue;var De=require("crypto");function Me(r,e,t){return(0,De.createHash)("sha256").update([r||"",e||"",t||""].join("\0")).digest("hex").slice(0,16)}var l="claude";function ds(r){return r.trim().toLowerCase().replace(/\s+/g,"-")}function L(r){if(!r)return l;let e=ds(r);return e?e==="transcript"||e.includes("codex")?"codex":e.includes("cursor")?"cursor":e.includes("claude")?"claude":e:l}function ve(r){let e=["claude","codex","cursor"];return[...r].sort((t,s)=>{let n=e.indexOf(t),o=e.indexOf(s);return n!==-1||o!==-1?n===-1?1:o===-1?-1:n-o:t.localeCompare(s)})}function ye(r,e,t,s,n){let o=Date.now()-s,i=n!==void 0?"up.session_db_id = ?":"up.content_session_id = ?",a=n??e;return r.prepare(`
    SELECT
      up.*,
      s.memory_session_id,
      s.project,
  ...
  `).get()!=null}function F(r,e,t){try{r.run(e)}catch(s){let n=s instanceof Error?s:new Error(String(s));throw E.warn("DB",`Failed to apply SQLite pragma ${t}`,{sql:e},n),s}}function Fe(r,e={}){let{enableWal:t=!0,enableIncrementalAutoVacuum:s=!0}=e;F(r,`PRAGMA busy_timeout = ${cs}`,"busy_timeout"),F(r,"PRAGMA foreign_keys = ON","foreign_keys"),F(r,"PRAGMA synchronous = NORMAL","synchronous"),F(r,`PRAGMA journal_size_limit = ${ms}`,"journal_size_limit"),s&&!ps(r)&&F(r,"PRAGMA auto_vacuum = INCREMENTAL","auto_vacuum"),t&&F(r,"PRAGMA journal_mode = WAL","journal_mode")}function $e(r){return r&&/^[A-Za-z0-9][A-Za-z0-9._-]{0,119}$/.test(r)?r:null}function ls(r){return r&&/^[A-Z][A-Z0-9_]{0,79}$/.test(r)?r:null}var Y=class{db;constructor(e=Ne,t={}){e instanceof me.Database?this.db=e:(e!==":memory:"&&Ae(N),this.db=new me.Database(e)),Fe(this.db),this.initializeSchema(),this.ensureWorkerPortColumn(),this.ensurePromptTrackingColumns(),this.removeSessionSummariesUniqueConstraint(),this.addObservationHierarchicalFields(),this.makeObservationsTextNullable(),this.createUserPromptsTable(),this.ensureDiscoveryTokensColumn(),this.createPendingMessagesTable(),this.renameSessionIdColumns(),this.addFailedAtEpochColumn(),this.addOnUpdateCascadeToForeignKeys(),this.addObservationContentHashColumn(),this.addSessionCustomTitleColumn(),this.addSessionPlatformSourceColumn(),this.addObservationModelColumns(),this.ensureMergedIntoProjectColumns(),this.addObservationSubagentColumns(),this.addObservationsUniqueContentHashIndex(),this.addObservationsMetadataColumn(),this.dropDeadPendingMessagesColumns(),this.ensurePendingMessagesToolUseIdColumn(),this.dropWorkerPidColumn(),this.ensureSDKSessionsPlatformContentIdentity(),this.ensureUserPromptsSessionDbId(),this.ensurePendingMessagesSessionToolUniqueIndex(),this.ensureSyncedAtColumns(t.cloudSyncStatePath??x.cloudSyncState()),this.requeuePromptCloudSyncAfterMapperFix(),this.createProviderAuditTable()}recordProviderAudit(e){let t=new Date,s=this.db.prepare(`
    ...
    `).run(t.toISOString(),t.getTime(),e.action,$e(e.providerId),$e(e.profileId),e.mode??null,e.outcome,ls(e.errorCode),e.classification??null,Math.max(0,Math.min(1e6,Math.trunc(e.redactionCount??0))));return Number(s.lastInsertRowid)}getRecentProviderAudits(e=100){let t=Math.max(1,Math.min(500,Math.trunc(e)));return this.db.query(`
    ...
    `).run();E.info("DB","Requeued prompt cloud sync after mapper fix (v40)",{requeued:t.changes}),this.db.prepare("INSERT OR IGNORE INTO schema_versions (version, applied_at) VALUES (?, ?)").run(40,new Date().toISOString())}createProviderAuditTable(){this.db.run(`
    ...
    `).get(e);if(!n)throw new Error(`Session ${e} not found in sdk_sessions`);n.memory_session_id!==t&&(this.db.prepare(`
      ...
      WHERE project IS NOT NULL AND project != ''
        AND project != ?
    `,n=[de];return t&&(s+=" AND COALESCE(platform_source, ?) = ?",n.push(l,t)),s+=" ORDER BY project ASC",this.db.prepare(s).all(...n).map(i=>i.project)}getProjectCatalog(){let e=this.db.prepare(`
      SELECT
    ...
    `).all(de),t=[],s=new Set,n={};for(let i of e){let a=L(i.platform_source);n[a]||(n[a]=[]),n[a].includes(i.project)||n[a].push(i.project),s.has(i.project)||(s.add(i.project),t.push(i.project))}let o=ve(Object.keys(n));return{projects:t,sources:o,projectsBySource:Object.fromEntries(o.map(i=>[i,n[i]||[]]))}}getLatestUserPrompt(e,t){let s=this.resolvePromptSessionDbId(e,t),n=s!==null?"up.session_db_id = ?":"up.content_session_id = ?",o=s!==null?s:e;return this.db.prepare(`
      ...
      ORDER BY up.created_at_epoch DESC
      LIMIT 1
    `).get(o)}findRecentDuplicateUserPrompt(e,t,s,n){return ye(this.db,e,q(t),s,this.resolvePromptSessionDbId(e,n)??void 0)}getRecentSessionsWithStatus(e,t=3,s){let n=[e],o="";return s&&(o=`AND COALESCE(NULLIF(s.platform_source, ''), '${l}') = ?`,n.push(L(s))),n.push(t),this.db.prepare(`
      SELECT * FROM (
        SELECT
          s.memory_session_id,
          s.status,
    ...
    `).get(e,L(t))||null:this.db.prepare(`
      ...
      ${m}
      ${p}
    `).all(...I);if(!u)return C;let U=new Map(C.map(A=>[A.id,A])),b=e.map(A=>U.get(A)).filter(A=>!!A);return n?b.slice(0,n):b}getSummaryForSession(e,t){let s=[e],n="";return t&&(n=`
        AND EXISTS (
          SELECT 1
    ...
    `).run(e,t,s.request,s.investigated,s.learned,s.completed,s.next_steps,s.notes,n||null,o,d,a);return{id:Number(u.lastInsertRowid),createdAtEpoch:a}}storeObservations(e,t,s,n,o,i=0,a,d){let _=a??Date.now(),u=new Date(_).toISOString();return this.db.transaction(()=>{let p=[],g=this.db.prepare(`
      ...
      ${d}
      ${_}
    `).all(...m);if(!a)return h;let f=new Map(h.map(C=>[C.id,C])),R=e.map(C=>f.get(C)).filter(C=>!!C);return n?R.slice(0,n):R}getUserPromptsByIds(e,t={}){if(e.length===0)return[];let{orderBy:s="date_desc",limit:n,project:o,platformSource:i}=t,a=s==="relevance",d=a?"":`ORDER BY up.created_at_epoch ${s==="date_asc"?"ASC":"DESC"}`,_=n?`LIMIT ${n}`:"",u=e.map(()=>"?").join(","),m=[...e],p=[];o&&(p.push("s.project = ?"),m.push(o)),i&&(p.push(`COALESCE(NULLIF(s.platform_source, ''), '${l}') = ?`),m.push(L(i)));let g=p.length>0?`AND ${p.join(" AND ")}`:"",h=this.db.prepare(`
      SELECT
        up.*,
        s.project,
        s.memory_session_id,
      ...
      ${d}
      ${_}
    `).all(...m);if(!a)return h;let f=new Map(h.map(R=>[R.id,R]));return e.map(R=>f.get(R)).filter(R=>!!R)}getTimelineAroundTimestamp(e,t=10,s=10,n,o){return this.getTimelineAroundObservation(null,e,t,s,n,o)}getTimelineAroundObservation(e,t,s=10,n=10,o,i){let a=i?L(i):void 0,d=(b,A)=>{let O=[],D=[];return o&&(O.push(`${b}.project = ?`),D.push(o)),a&&(O.push(`COALESCE(NULLIF(${A}.platform_source, ''), '${l}') = ?`),D.push(a)),{clause:O.length>0?`AND ${O.join(" AND ")}`:"",params:D}},_=d("o","src"),u=d("ss","src"),m=d("s","s"),p,g;if(e!==null){let b=`
...
`}function Mt(r,e,t,s){let n=[];return s?n.push(...gt(r)):n.push(...ot(r)),s?n.push(...St()):n.push(...it()),s&&(n.push(...ft()),n.push(...Rt())),ee(t)&&(s?n.push(...bt(e,t)):n.push(...at(e,t))),n}var Se=X(require("path"),1);function ne(r){if(!r)return[];try{let e=JSON.parse(r);return Array.isArray(e)?e:[]}catch(e){return E.debug("PARSER","Failed to parse JSON array, using empty fallback",{preview:r?.substring(0,50)},e instanceof Error?e:new Error(String(e))),[]}}function fe(r){return new Date(r).toLocaleString("en-US",{month:"short",day:"numeric",hour:"numeric",minute:"2-digit",hour12:!0})}function Re(r){return new Date(r).toLocaleString("en-US",{hour:"numeric",minute:"2-digit",hour12:!0})}function yt(r){return new Date(r).toLocaleString("en-US",{month:"short",day:"numeric",year:"numeric"})}function vt(r,e){return Se.default.isAbsolute(r)?Se.default.relative(e,r):r}function Ut(r,e,t){let s=ne(r);if(s.length>0)return vt(s[0],e);if(t){let n=ne(t);if(n.length>0)return vt(n[0],e)}return"General"}function hs(r){let e=new Map;for(let s of r){let n=s.type==="observation"?s.data.created_at:s.data.displayTime,o=yt(n);e.has(o)||e.set(o,[]),e.get(o).push(s)}let t=Array.from(e.entries()).sort((s,n)=>{let o=new Date(s[0]).getTime(),i=new Date(n[0]).getTime();return o-i});return new Map(t)}function xt(r,e){return e.fullObservationField==="narrative"?r.narrative:r.facts?ne(r.facts).join(`
`):null}function Is(r,e,t,s){let n=[];n.push(...dt(r));let o="";for(let i of e)if(i.type==="summary"){let a=i.data,d=fe(a.displayTime);n.push(...ct(a,d))}else{let a=i.data,d=Re(a.created_at),u=d!==o?d:"";if(o=d,t.has(a.id)){let p=xt(a,s);n.push(...ut(a,u,p,s))}else n.push(Et(a,u,s))}return n}function Ns(r,e,t,s,n){let o=[];o.push(...Ot(r));let i=null,a="";for(let d of e)if(d.type==="summary"){i=null,a="";let _=d.data,u=fe(_.displayTime);o.push(...At(_,u))}else{let _=d.data,u=Ut(_.files_modified,n,_.files_read),m=Re(_.created_at),p=m!==a;a=m;let g=t.has(_.id);if(u!==i&&(o.push(...ht(u)),i=u),g){let I=xt(_,s);o.push(...Nt(_,m,p,I,s))}else o.push(It(_,m,p,s))}return o.push(""),o}function As(r,e,t,s,n,o){return o?Ns(r,e,t,s,n):Is(r,e,t,s)}function wt(r,e,t,s,n){let o=[],i=hs(r);for(let[a,d]of i)o.push(...As(a,d,e,t,s,n));return o}function kt(r,e,t){return!(!r.showLastSummary||!e||!!!(e.investigated||e.learned||e.completed||e.next_steps)||t&&e.created_at_epoch<=t.created_at_epoch)}function Pt(r,e){let t=[];return e?(t.push(...j("Investigated",r.investigated,c.blue)),t.push(...j("Learned",r.learned,c.yellow)),t.push(...j("Completed",r.completed,c.green)),t.push(...j("Next Steps",r.next_steps,c.magenta))):(t.push(...W("Investigated",r.investigated)),t.push(...W("Learned",r.learned)),t.push(...W("Completed",r.completed)),t.push(...W("Next Steps",r.next_steps))),t}function Ft(r,e){return e?Lt(r):mt(r)}function $t(r,e,t){return!ee(e)||r.totalDiscoveryTokens<=0||r.savings<=0?[]:t?Ct(r.totalDiscoveryTokens,r.totalReadTokens):pt(r.totalDiscoveryTokens,r.totalReadTokens)}var Ls=Xt.default.join((0,Gt.homedir)(),".claude","plugins","marketplaces","thedotmack","plugin",".install-version");function Cs(){try{return new Y}catch(r){if(r instanceof Error&&r.code==="ERR_DLOPEN_FAILED"){try{(0,Ht.unlinkSync)(Ls)}catch(e){e instanceof Error?E.debug("WORKER","Marker file cleanup failed (may not exist)",{},e):E.debug("WORKER","Marker file cleanup failed (may not exist)",{error:String(e)})}return E.error("WORKER","Native module rebuild needed - restart Claude Code to auto-fix"),null}throw r}}function Ds(r,e){return e?Dt(r):lt(r)}function Ms(r,e,t,s,n,o,i){let a=[],d=ge(e);a.push(...Mt(r,d,s,i));let _=t.slice(0,s.sessionCount),u=tt(_,t),m=st(e,u),p=rt(e,s.fullObservationCount);a.push(...wt(m,p,s,n,i));let g=t[0],I=e[0];kt(s,g,I)&&a.push(...Pt(g,i));let h=et(e,s,o,n);return a.push(...Ft(h,i)),a.push(...$t(d,s,i)),a.join(`
`).trimEnd()}var vs=new Set(["bugfix","discovery","decision","refactor"]);function ys(r,e,t){let s=ge(r),n={bugfix:0,discovery:0,decision:0,refactor:0,other:0},o=new Set,i=Number.POSITIVE_INFINITY;for(let d of r){let _=vs.has(d.type)?d.type:"other";n[_]++,d.memory_session_id&&o.add(d.memory_session_id),d.created_at_epoch&&d.created_at_epoch<i&&(i=d.created_at_epoch)}let a=Number.isFinite(i)?Math.max(0,Math.floor((Date.now()-i)/864e5)):0;return{observation_count:r.length,session_count:o.size,timeline_depth_days:a,has_session_summary:e.length>0,obs_type_bugfix:n.bugfix,obs_type_discovery:n.discovery,obs_type_decision:n.decision,obs_type_refactor:n.refactor,obs_type_other:n.other,tokens_injected:s.totalReadTokens,tokens_saved_vs_naive:s.savings,search_strategy:t?"full":"timeline"}}async function be(r,e=!1){let t=qe(),s=r?.cwd??process.cwd(),n=je(s),o=r?.projects?.length?r.projects:n.allProjects,i=o[o.length-1]??n.primary;r?.full&&(t.totalObservationCount=999999,t.sessionCount=999999);let a=Cs();if(!a)return{text:"",stats:null};try{let d=r?.platformSource?L(r.platformSource):void 0,_=o.length>1?o:[i],u=ze(a,_,t,d),m=Ze(a,_,t,d);return u.length===0&&m.length===0?{text:Ds(i,e),stats:null}:{text:Ms(i,u,m,t,s,r?.session_id,e),stats:ys(u,m,!!r?.full)}}finally{a.close()}}async function Bt(r,e=!1){return(await be(r,e)).text}0&&(module.exports={generateContext,generateContextWithStats});
